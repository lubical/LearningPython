...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens,
    ...
    buton_clicked = play_button.rect.collidepoint(mouse_x, mouse_y)
    if buton_clicked and not stats.game_active:
...
def check_fleet_edgess(ai_settings, aliens):
...
def update_aliens(ai_settings, screen, stats, sb,  ship, aliens, bullets):
    ...
    check_fleet_edgess(ai_settings, aliens)
    aliens.update()
